...
int main()
{
    Driver D[100];
    Passenger P[100];
    string Loc[] = {"MUMBAI","THANE","NASHIK","AKOLA","NAGPUR"};
                ...
                while (loginAttempt < 5)
    {
        ...
        if (userName == "Janhavi" && userPassword == "jan")
        {
            cout << "Welcome Janhavi!!\n";
            break;
        }
        else if (userName == "Chirag" && userPassword == "chi")
        {
            cout << "Welcome Chirag!!\n";
            break;
        }
        else if (userName == "Sarang" && userPassword == "sar")
        {
            cout << "Welcome Sarang!!\n";
            break;
        }
        else if (userName == "Mansi" && userPassword == "man")
        {
            cout << "Welcome Mansi!!\n";
            break;
        }
        else if (userName == "Anjali" && userPassword == "anj")
        {
            cout << "Welcome Anjali!!\n";
            break;
        }
                ...
                while (loginAttempt < 5)
    {
        ...
        if (userName == "Janhavi" && userPassword == "jan15")
        {
            cout << "Welcome Janhavi!!\n";
            break;
        }
        else if (userName == "Chirag" && userPassword == "maha")
        {
            cout << "Welcome Chirag!!\n";
            break;
        }
    ...
    if(P[p].stp>P[p].destp)
    {
        for(int i=0;i<d;i++)
        {
            if(D[i].stdr > D[i].destdr && D[i].nos!=0)
            {
                ...
                {
                    D[i].display();
                    cout<<"ENTER "<<i+1<<" TO CONFIRM YOUR RIDE WITH "<<D[i].name<<" OR 0 TO NOT CONFIRM IT"<<endl;
                    cout<<"*****************"<<endl;
                    flag = 1;
